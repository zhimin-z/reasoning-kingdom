...
"我们选深碗路，"兔狲说，"数据多样性造出了陡峭的碗，这是最好的推理地形。"
...
"幸好我们的模型架构平滑，"学生小海豹说，"$L$小，可以放心走。"

**第三幕：决定步幅**

兔狲拿出"下山安全公式"：$η < \frac{2μ}{L^2}$

"$μ$大（碗陡），$L$小（路平），"小小猪计算着，"我们可以用大步长$η$！"
...
"我们的 $(μ, L, η)$ 组合得好，"兔狲说，"$k$小，很快就能接近山顶！"

**第五幕：永霖观察**

但学生们发现不对劲——无论怎么走，最后都回到**训练营地**，而不是真理山顶。

"啊！"兔狲恍然大悟，"训练数据把我们带到了这里，这是**先验锚点** $A = P_D(y)$！"
...
"这就是我们的**有效推理窗口**，"兔狲说，"在 $t_{\text{eff}}$ 步内，我们还能探索新地形。之后，山的引力会把我们拉回营地。"

**第七幕：元层断裂**

学生们想："既然知道会回营地，为什么不直接验证方向？"

但发现：**产生推理的机制**（梯度下降）和**验证推理的机制**（判断对错）是断裂的。
